            ...
            if (mapboxResponse.data.features && mapboxResponse.data.features.length > 0) {
                ...
                if (user) {
                    if (user.role === 'ROLE_LANDLORD') {
                        endpoint = endpoints.tenantPost;
                    }
                } 
                endpoint = endpoints.getlLandlordPost;


                try {
                    const postsResponse = await APIs.get(endpoint, {
                        params: {
                            lat: location2[1],
                            lng: location2[0],
                            radius: radius,
                                ...
                                <Card style={{ width: '18rem' }}>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            ...
                                            {c.roomId.yaddress && c.roomId.address}
                                        </Card.Text>
                                        <a href={`/landlordposts/${c.roomId.id}/`} className="cs-btn-detail btn btn-default text-white">Chi tiết</a>
                                    </Card.Body>
                                </Card>
                            </div>
                        ))
